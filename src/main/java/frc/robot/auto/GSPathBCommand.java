...
public class GSPathBCommand extends SequentialCommandGroup {

    PixyCamSubsystem pixyCam = null;

    public TrajectoryFactory trajectoryFactory = new TrajectoryFactory();

    public GSPathBCommand(DriveTrainSubsystem driveTrain, IntakeSubsystem intake, VisionSubsystem vision) {
        ...
        if(ballArray.size() == 3){
            ...
            //red path
            if(firstBall.centerX >=250 && (thirdBall.centerX<=80)){
