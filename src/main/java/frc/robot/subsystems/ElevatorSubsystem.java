...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public ElevatorSubsystem() {
      ...
      lockinSolenoid = new Solenoid(PneumaticsModuleType.REVPH, Constants.Solenoids.kElevatorLockSolenoidID);
      lockoutSolenoid = new Solenoid(PneumaticsModuleType.REVPH, Constants.Solenoids.kElevatorUnLockSolenoidID);
  }
